...
(() => {
var exports = {};
exports.id = "pages/api/agenda/horarios";
exports.ids = ["pages/api/agenda/horarios"];
exports.modules = {
...
/***/ "(api)/./src/pages/api/agenda/horarios.js":
/*!******************************************!*\
  !*** ./src/pages/api/agenda/horarios.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../database */ \"(api)/./src/database/index.js\");\n/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_database__WEBPACK_IMPORTED_MODULE_0__);\n\nasync function GetHorarios(request, response) {\n    let results;\n    let horarios = [\n        \"07:00:00\",\n        \"08:00:00\",\n        \"09:00:00\",\n        \"10:00:00\",\n        \"11:00:00\",\n        \"12:00:00\",\n        \"13:00:00\",\n        \"14:00:00\",\n        \"15:00:00\",\n        \"16:00:00\",\n        \"17:00:00\"\n    ];\n    try {\n        results = await _database__WEBPACK_IMPORTED_MODULE_0___default().select(\"hora\").from(\"agenda\").where({\n            codigoMedico: request.query.codigomedico,\n            data: request.query.data\n        }).orderBy(\"hora\", \"asc\");\n        let model = horarios.filter((horario)=>!results.map((raw)=>raw.hora).includes(horario));\n        console.log(model + \"aa\");\n        return response.send(model);\n    } catch (error) {\n        return response.json({\n            message: error.message\n        }).send(500);\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (GetHorarios);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./src/pages/api/agenda/horarios.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./src/pages/api/agenda/horarios.js"));
