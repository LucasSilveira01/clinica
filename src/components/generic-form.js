...
const GenericForm = ({ type }) => {
            ...
            switch (type) {
                ...
                case "funcionario":
                    await post("funcionario", {
                        ...
                        data_contrato: `${formDataInicio.getFullYear()}-${formDataInicio.getMonth() + 1 < 10
                ...
                case "consulta":
                    await post("agenda", {
                        data: `${formDataConsulta.getFullYear()}-${formDataConsulta.getMonth() + 1 < 10
    ...
    const handleSetFormDataConsulta = (value) => {
        ...
        get("agenda/horarios", {
            codigomedico: formMedico,
            data: `${value.getFullYear()}-${value.getMonth() + 1 < 10
                    ? "0" + (value.getMonth() + 1)
                    : value.getMonth() + 1
